...
<section class="phan-san-pham-noi-bat">
    ...
    <div class="khung-san-pham">
        ...
        <!-- === SẢN PHẨM 1 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/Flycam%20DJI%20Air%203.png" alt="FlycamDJlAir3">
        ...
        <!-- === SẢN PHẨM 2 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/Flycam%20DJl%20Inspire%203.png" alt="FlycamDJlInspire3">
                <h3 class="ten-san-pham">Flycam DJl Inspire 3</h3>
                <div class="gia"><b>9.990.000 ₫</b>
                    <span class="gia-goc">12.500.000 ₫</span>
                </div>
        ...
        <!-- === SẢN PHẨM 3 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/DJI%20Mavic%203%20Pro%20With%20DJI%20RC%20Remote.png"
                                     alt="DJIMavic3ProWithDJIRCRemote">
                <h3 class="ten-san-pham">DJI Mavic 3 Pro With DJI RC Remote</h3>
                <div class="gia"><b>49.990.000 ₫</b>
                    <span class="gia-goc">55.000.000 ₫</span>
        ...
        <!-- === SẢN PHẨM 4 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/Flycam%20DJI%20Mavic%20Mini%20SE%20Combo.png"
                                     alt="FlycamDJIMavicMiniSECombo">
                <h3 class="ten-san-pham">Flycam DJI Mavic Mini SE Combo</h3>
                <div class="gia"><b>29.290.000 ₫</b>
                    <span class="gia-goc">31.000.000 ₫</span>
        ...
        <!-- === SẢN PHẨM 5 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/DJI%20Mini%203.png" alt="DJlMini3">
        ...
        <!-- === SẢN PHẨM 6 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/DJI%20Flip.png" alt="DJlFlip">
        ...
        <!-- === SẢN PHẨM 7 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/DJI%20Mini%205%20Pro.png" alt="DJlMini5Pro">
        ...
        <!-- === SẢN PHẨM 8 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/content/DJI%20Mini%204K.png" alt="DJlMini4K">
        ...
        <!-- === SẢN PHẨM 10 === -->
        <div class="san-pham">
            <a href="login.jsp"><img src="../image/filmProduct/Flycam%20DJI%20O4%20Air%20Unit.png"
