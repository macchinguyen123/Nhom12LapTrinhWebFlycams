...
<section class="phan-san-pham">
    <h2 class="tieu-de-muc">Drone du lịch - vlog</h2>
    ...
    <div class="khung-san-pham">
        <!-- 21 sản phẩm Drone du lịch / vlog -->
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mini%203%20Pro.png" alt="DJIMini3Pro">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mini%204%20Pro.png" alt="DJIMini4Pro">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mini%20SE.png" alt="DJIMiniSE">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Air%202S.png" alt="DJIAir2S">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Air%203.png" alt="DJIAir3">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mini%202%20SE.png">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mini%203%20Travel%20Edition.png">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mavic%20Air%202.png">
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mavic%203%20Classic.png">
                <h3 class="ten-san-pham">DJI Mavic 3 Classic</h3>
                <div class="gia"><b>28.490.000 ₫</b><span class="gia-goc">29.190.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/DJI%20Mavic%203%20Pro.png">
                <h3 class="ten-san-pham">DJI Mavic 3 Pro</h3>
                <div class="gia"><b>96.860.000 ₫</b><span class="gia-goc">98.290.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Autel%20EVO%20Lite+.png">
                <h3 class="ten-san-pham">Autel EVO Lite+</h3>
                <div class="gia"><b>5.290.000 ₫</b><span class="gia-goc">9.790.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Autel%20EVO%20Lite.png">
                <h3 class="ten-san-pham">Autel EVO Lite</h3>
                <div class="gia"><b>3.890.000 ₫</b><span class="gia-goc">4.990.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Hubsan%20Zino%20Mini%20SE.png">
                <h3 class="ten-san-pham">Hubsan Zino Mini SE</h3>
                <div class="gia"><b>8.200.000 ₫</b><span class="gia-goc">9.890.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Flycam%20E99%20Travel%20Pro.png">
                <h3 class="ten-san-pham">Flycam E99 Travel Pro</h3>
                <div class="gia"><b>4.790.000 ₫</b><span class="gia-goc">5.790.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Flycam%20Air%20Trip%20Pro.png">
                <h3 class="ten-san-pham">Flycam Air Trip Pro</h3>
                <div class="gia"><b>42.590.000 ₫</b><span class="gia-goc">43.390.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Drone%20SkyView%204K.png">
                <h3 class="ten-san-pham">Drone SkyView 4Kr</h3>
                <div class="gia"><b>3.690.000 ₫</b><span class="gia-goc">4.690.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/SJRC%20F11%204K%20Pro.png">
                <h3 class="ten-san-pham">SJRC F11 4K Pro</h3>
                <div class="gia"><b>9.990.000 ₫</b><span class="gia-goc">11.690.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Flycam%20T900%20Explorer.png">
                <h3 class="ten-san-pham">Flycam T900 Explorer</h3>
                <div class="gia"><b>2.290.000 ₫</b><span class="gia-goc">4.090.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/C-Fly%20SmartCam%20S.png">
                <h3 class="ten-san-pham">C-Fly SmartCam S</h3>
                <div class="gia"><b>1.490.000 ₫</b><span class="gia-goc">2.890.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Flycam%20Breeze%20Go.png">
                <h3 class="ten-san-pham">Flycam Breeze Go</h3>
                <div class="gia"><b>7.290.000 ₫</b><span class="gia-goc">8.590.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i></div>
        ...
        <div class="san-pham">
            <a href="../product-details.jsp">
                <img src="../../image/travelProduct/Drone%20Mini%20Scout.png">
                <h3 class="ten-san-pham">Drone Mini Scout</h3>
                <div class="gia"><b>8.990.000 ₫</b><span class="gia-goc">9.890.000 ₫</span></div>
            </a>
            <div class="hang-danh-gia">
                <div class="danh-gia-sao"><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                        class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></div>
    ...
    <div class="footer-container">
        ...
        <div class="footer-column">
            ...
            <ul>
                ...
                <li><a href="/page/category/tourism-drone.html">Drone du lịch / vlog</a></li>
