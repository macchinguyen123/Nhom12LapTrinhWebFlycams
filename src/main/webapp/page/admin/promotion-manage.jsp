        ...
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/admin/promotion-manage" method="post"
                ...
                <div class="modal-body row g-3">
                    ...
                    <!-- Áp cho danh mục -->
                    <!-- Áp cho danh mục - UPDATED WITH SELECTION UI -->
        ...
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/admin/promotion-manage" method="post"
                ...
                <div class="modal-body row g-3">
                    ...
                    <!-- MODAL SỬA KHUYẾN MÃI - Thêm phần category selection tương tự -->
...
<script>
    ...
    $(document).on('click', '.btn-edit', function () {
        ...
        // ✅ FIX: Đảm bảo xóa backdrop cũ trước khi mở modal mới
        $('.modal-backdrop').remove();
        $('body').removeClass('modal-open');

        // Show modal với cách khởi tạo đúng
    ...
    $('#modalEditPromotion').on('hidden.bs.modal', function () {
        ...
        // ✅ FIX: Đảm bảo xóa hoàn toàn backdrop
        $('.modal-backdrop').remove();
        $('body').removeClass('modal-open');
        $('body').css('overflow', '');
