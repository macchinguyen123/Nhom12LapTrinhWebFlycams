                    ...
                    <div class="modal-body">
                        <form id="bieuMauKhuyenMai" class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="maKhuyenMai"
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id="maSanPhamRieng" class="form-control"
                                    placeholder="VD: SP001, SP002">
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-bold mt-2">Mã danh mục áp dụng riêng (nếu có)</label>
                                <input type="text" id="maDanhMucRieng" class="form-control"
                                    placeholder="VD: DM001, DM002">
                            </div>
