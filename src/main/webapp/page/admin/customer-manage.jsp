                    ...
                    <div class="layout">
                        ...
                        <main class="main-content container-fluid p-4">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="text-primary fw-bold"><i class="bi bi-person-lines-fill"></i> Quản Lý Tài
                                    Khoản
                                </h4>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Tên đăng nhập <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="username" value="${detailUser.username}"
                                required>
                        </div>
                        <!-- Mật khẩu đã mã hóa -->
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="gender">
                                    ...
                                    <option value="Khác" <c:if test="${detailUser.gender eq 'Khác'}">selected</c:if>
                                        >Khác
                                    </option>
                                </select>
                            </div>
